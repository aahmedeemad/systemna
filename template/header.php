            ...
            <div class="mainPage">
                ...
                <div class="sidenav-custom">
                    ...
                    <ul>
                        ...
                        <li class="sidenav-button"><a href="../pages/AddNewLetter.php"><i class='fas fa-clock fa-sm icon-button'></i><span class="button-text"> Add New type of letter</span></a></li><li class="sidenav-button"></li>
