    ...
    <body>
        <div class="container">
            <header class="header">
                ...
                <a style="text-decoration: none;" href="../pages/index.php"><div class="logo-name"><strong style="color: #DAA520">System</strong><strong style="color: white">na</strong></div></a>
            ...
            <div class="mainPage">
                <div class="sidenav">
                        ...
                        <div class="sidenav-header">
                            ...
                            <div class="title">
                                <a style="text-decoration: none;" href="../pages/profile.php"><h1 class="name"><?php echo explode(" ", $SESSION['username'])[0] ?></h1></a>
