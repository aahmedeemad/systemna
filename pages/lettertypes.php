...
<div id="row">
    <form method="post">
        <div id="column">
            <br>
            <b><input type="button" class="Letterbutton" id="btn2" value="General HR Letter"></b>
        </div>
        <div id="column">
            <br>
            <b><input type="button" class="Letterbutton" id="btn3" value="Embassy HR Letter"> </b>
        </div>
        <div id="column">
            <br>
        ...
        <div id="column">
            <br>
            <b> <input type="button" class="Letterbutton" id="btn5" value="HR Letter to whom it may concern"></b>

        </div>
        <br><br>
        <div id="Priorityform">
            <h4> Please choose the Letter priority : </h4>
            <label><input type="radio" name="Option1" id="rdbtn1" value="Urgent" required> Urgent Request</label><br>
        ...
        <div>
            ...
            <label><input type="radio" name="Option" id="rdbtn3" value="With" required> With Salary</label><br>
